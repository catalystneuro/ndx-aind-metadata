...
# Next Steps for ndx-aind-metadata Extension for NWB

## Creating Your Extension

1. In a terminal, change directory into the new ndx-aind-metadata directory: `cd ndx-aind-metadata`
...
`spec/ndx-aind-metadata.namespace.yaml` and
`spec/ndx-aind-metadata.extensions.yaml` files.
...
2. Start a git repository for your extension directory ndx-aind-metadata
...
8. Make a release for the extension on GitHub with the version number specified. e.g. if version is 0.1.0, then this page should exist: https://github.com/myname/ndx-aind-metadata/releases/tag/0.1.0 . For instructions on how to make a release on GitHub see [here](https://help.github.com/en/github/administering-a-repository/creating-releases).
...
9. Publish your updated extension on [PyPI](https://pypi.org/).
    ...
    - If your extension version is 0.1.0, then this page should exist: https://pypi.org/project/ndx-aind-metadata/0.1.0
...
`staged-extensions/ndx-aind-metadata`:

    ```bash
    cp -r staged-extensions/example staged-extensions/ndx-aind-metadata
    ```

13. Edit `staged-extensions/ndx-aind-metadata/ndx-meta.yaml`
with information on where to find your NWB extension.
    ...
    - You may copy and modify the following YAML that was auto-generated:
      ...
      version: 0.1.0
      src: https://github.com/myname/ndx-aind-metadata
      pip: https://pypi.org/project/ndx-aind-metadata/
      license: MIT
      maintainers: 
        - myname
      ```

14. Edit `staged-extensions/ndx-aind-metadata/README.md`
to add information about your extension. You may copy it from
`ndx-aind-metadata/README.md`.

  ```bash
  cp ndx-aind-metadata/README.md staged-extensions/ndx-aind-metadata/README.md
  ```

15. Add and commit your changes to Git and push your changes to GitHub.
```
cd staged-extensions
git add ndx-aind-metadata
git commit -m "Add new catalog entry for ndx-aind-metadata" .
git push
```
...
ndx-aind-metadata-record will be created in the nwb-extensions
GitHub organization and you will be added as a maintainer for that repository.


## Updating Your Published Extension

1. Update your ndx-aind-metadata GitHub repository.

2. Publish your updated extension on PyPI.

3. Fork the ndx-aind-metadata-record repository on GitHub.
